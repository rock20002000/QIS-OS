...
typedef __SIZE_TYPE__ addr_t;
typedef addr_t paddr_t;
typedef addr_t vaddr_t;
typedef size_t gpaddr_t;
typedef size_t offset_t;

typedef paddr_t	phys_addr_t;


typedef uint32_t				addr32t;
typedef uint64_t				addr64t;

typedef addr32t                 paddr32_t;
typedef addr64t                 paddr64_t;

#define NULL_ADDR				((addr_t)~0L)
#define NULL_VADDR				NULL_ADDR
#define NULL_PADDR				NULL_ADDR
