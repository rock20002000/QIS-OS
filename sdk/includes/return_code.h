...
#ifndef SDK_LIB_LIBC_INCLUDE_RETURN_CODE_H_
#define SDK_LIB_LIBC_INCLUDE_RETURN_CODE_H_

typedef int error_t;

#define IS_ERROR(err)      ((error_t)(err) < 0)
#define IS_OK(err)         ((error_t)(err) >= 0)
...
*/
#endif // SDK_LIB_LIBC_INCLUDE_RETURN_CODE_H_
