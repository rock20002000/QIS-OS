#ifndef	SDK_LIB_INCLUDE_ARM_MX6X_H
#define	SDK_LIB_INCLUDE_ARM_MX6X_H
...
#define MX6X_ANATOP_PFD_528_TOG        
...
#define MX6X_SNVS_HPSR							0x14    // HP Status
#define MX6X_SNVS_LPCR							0x38    // LP Control
#define MX6X_SNVS_LPSR							0x4C    // LP Status
#define MX6X_SNVS_LPSRTCMR						0x50    // LP Secure Real Time Counter MSB
#define MX6X_SNVS_LPSRTCLR						0x54    // LP Secure Real Time Counter LSB
#define MX6X_SNVS_LPTAR							0x58    // LP Time Alarm
#define MX6X_SNVS_LPSMCMR						0x5C    // LP Secure Monotonic Counter MSB
#define MX6X_SNVS_LPSMCLR						0x60    // LP Secure Monotonic Counter LSB
#define MX6X_SNVS_LPPGDR						0x64    // LP Power Glitch Detector
#define MX6X_SNVS_LPGPR							0x68    // LP General Purpose
...
#define MX6X_SDMA_RESET                         0x24	// Reset
#define MX6X_SDMA_EVTERR                        0x28	// DMA Request Error
#define MX6X_SDMA_INTRMASK                      0x2C	// Channel AP Interrupt Mask
#define MX6X_SDMA_PSW                           0x30	// Schedule Status
#define MX6X_SDMA_EVTERRDBG                     0x34	// DMA Request Error
#define MX6X_SDMA_CONFIG                        0x38	// Configuration
#define MX6X_SDMA_ONCE_ENB                      0x40	// OnCE Enable
#define MX6X_SDMA_ONCE_DATA                     0x44	// OnCE Data
#define MX6X_SDMA_ONCE_INSTR                    0x48	// OnCE Instruction
#define MX6X_SDMA_ONCE_STAT                     0x4C	// OnCE Status
#define MX6X_SDMA_ONCE_CMD                      0x50	// OnCE Command
...
#define MX6X_EPIT_CR                            0x00    // Control
#define MX6X_EPIT_SR                            0x04    // Status
#define MX6X_EPIT_LR                            0x08    // Load
#define MX6X_EPIT_CMPR                          0x0C    // Compare
#define MX6X_EPIT_CNR                           0x10    // Counter
...
#endif	// SDK_LIB_INCLUDE_ARM_MX6X_H
