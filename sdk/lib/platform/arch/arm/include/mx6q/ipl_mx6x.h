#ifndef SDK_LIB_INCLUDE_IPL_MX6X_H
#define SDK_LIB_INCLUDE_IPL_MX6X_H
...
#define MXC_UART_RXDATA        *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0x00)     // Receiver
#define MXC_UART_TXDATA        *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0x40)     // Transmitter
...
#define MXC_UART_FCR           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0x90)     // FIFO Control
...
#define MXC_UART_ESC           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0x9C)     // Escape Character
#define MXC_UART_TIM           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0xA0)     // Escape Timer
#define MXC_UART_BIR           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0xA4)     // BRM Incremental
#define MXC_UART_BMR           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0xA8)     // BRM Modulator
#define MXC_UART_BRC           *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0xAC)     // Baud Rate Count
...
#define MXC_UART_TS            *(volatile unsigned short *) (MXC_CONSOLE_BASE + 0xB4)     // Test
...
#endif  // SDK_LIB_INCLUDE_IPL_MX6X_H
